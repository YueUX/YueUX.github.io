(function($) {
  ...
  $(document).ready(function(){
    ...
    //pop up porfolio
    $('.portfolio-image-ui li a').magnificPopup({
      type: 'iframe',
      gallery: {
        enabled: true
      }
    ...
    //pop up porfolio
    $('.portfolio-image-ux li a').magnificPopup({
      type: 'iframe',
      gallery: {
        enabled: true
      }
    ...
    //pop up porfolio
    $('.portfolio-image-tangible li a').magnificPopup({
      type: 'iframe',
      gallery: {
        enabled: true
      }
    ...
    //pop up porfolio
    $('.portfolio-image-graphics li a').magnificPopup({
      type: 'image',
      gallery: {
        enabled: true
      }
